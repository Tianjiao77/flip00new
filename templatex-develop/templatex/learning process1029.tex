...
\hypersetup{ % TODO: PDF meta Data
  pdftitle={Flip00 learning process and plan},
  pdfauthor={Tianjiao Wang},
...
%
\title{Flip00 learning process and plan}
\author{
Tianjiao Wang
\\
...
cf={Flip00 learning process and plan},
}
...
%%==========================================================================================
%%
\begin{slide}{This week}
\begin{center}
\twotonebox{\rotatebox{90}{ }}{\parbox{.86\textwidth}
{Python
\begin{itemize}
\item Python Basics
\item Fundamental Package
...
%%==========================================================================================
%%
\begin{slide}[toc=,bm=]{This week}
\twotonebox {\rotatebox{90}{ }}{\parbox{.88\textwidth}
{
{git
\begin{itemize}
\item
